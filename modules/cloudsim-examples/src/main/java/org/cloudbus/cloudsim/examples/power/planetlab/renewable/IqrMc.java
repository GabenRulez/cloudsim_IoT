...
public class IqrMc {
	...
	public static void main(String[] args) throws IOException {
		...
		PhotovoltaicFarm photovoltaicFarm = new PhotovoltaicFarm();

		RenewableEnergySource renewableEnergySource = new RenewableEnergySource(photovoltaicFarm, bsrnDataLoader);
